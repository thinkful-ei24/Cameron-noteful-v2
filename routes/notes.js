...
router.get('/', (req, res, next) => {
  ...
  knex.select('notes.id', 'title', 'content', 'folders.id as folderId', 'folders.name as folderName', 'tag_id', 'tags.name as tagName')
    .from('folders')
    .leftJoin('notes', 'folders.id', 'notes.folder_id')
